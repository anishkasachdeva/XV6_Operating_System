...
_roundtest:     file format elf32-i386
...
main(void)
{
  ...
  15:	83 ec 2c             	sub    $0x2c,%esp
    for(int i=0;i<5;i++)
    {
        if(fork() == 0)
  18:	e8 0d 03 00 00       	call   32a <fork>
...
main(void)
{
  ...
  24:	75 f2                	jne    18 <main+0x18>
    ...
    {
        wait();
  26:	e8 0f 03 00 00       	call   33a <wait>
  2b:	e8 0a 03 00 00       	call   33a <wait>
  30:	e8 05 03 00 00       	call   33a <wait>
  35:	e8 00 03 00 00       	call   33a <wait>
  3a:	e8 fb 02 00 00       	call   33a <wait>
    }
    exit();
  3f:	e8 ee 02 00 00       	call   332 <exit>
{
    for(int i=0;i<5;i++)
    {
        if(fork() == 0)
  ...
  44:	c7 45 e0 05 00 00 00 	movl   $0x5,-0x20(%ebp)
  4b:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
            for(;i<1e7;i++)
            {
                // if(i==2e7){
  ...
  52:	be 83 de 1b 43       	mov    $0x431bde83,%esi
    for(int i=0;i<5;i++)
    {
        if(fork() == 0)
        {
  ...
  57:	8b 45 e4             	mov    -0x1c(%ebp),%eax
            {
                ...
                // }
                if(i%((int)1e6)==0)printf(1, "At %d stage of proc %d\n", i/(int)1e6, getpid());
  5a:	bb 40 42 0f 00       	mov    $0xf4240,%ebx
    for(int i=0;i<5;i++)
    {
        if(fork() == 0)
        {
            volatile int a=5,i = 0;
            for(;i<1e7;i++)
  5f:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  62:	db 45 d4             	fildl  -0x2c(%ebp)
  65:	d9 05 c8 07 00 00    	flds   0x7c8
  6b:	df e9                	fucomip %st(1),%st
  6d:	dd d8                	fstp   %st(0)
  6f:	77 2e                	ja     9f <main+0x9f>
  71:	eb 67                	jmp    da <main+0xda>
  73:	90                   	nop
  74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            {
                ...
                if(i%((int)1e6)==0)printf(1, "At %d stage of proc %d\n", i/(int)1e6, getpid());
                a += (int)(3);
  78:	8b 45 e0             	mov    -0x20(%ebp),%eax
  7b:	83 c0 03             	add    $0x3,%eax
  ...
  90:	db 45 d4             	fildl  -0x2c(%ebp)
  93:	d9 05 c8 07 00 00    	flds   0x7c8
  99:	df e9                	fucomip %st(1),%st
  9b:	dd d8                	fstp   %st(0)
  9d:	76 3b                	jbe    da <main+0xda>
            {
                // if(i==2e7){
                //     set_priority(100 - i/2, getpid());
                // }
                if(i%((int)1e6)==0)printf(1, "At %d stage of proc %d\n", i/(int)1e6, getpid());
  9f:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  a2:	89 c8                	mov    %ecx,%eax
  a4:	f7 ee                	imul   %esi
  a6:	89 c8                	mov    %ecx,%eax
  a8:	c1 f8 1f             	sar    $0x1f,%eax
  ab:	c1 fa 12             	sar    $0x12,%edx
  ae:	29 c2                	sub    %eax,%edx
  b0:	69 d2 40 42 0f 00    	imul   $0xf4240,%edx,%edx
  b6:	39 d1                	cmp    %edx,%ecx
  b8:	75 be                	jne    78 <main+0x78>
  ba:	e8 f3 02 00 00       	call   3b2 <getpid>
  ...
  c6:	f7 fb                	idiv   %ebx
  c8:	50                   	push   %eax
  c9:	68 b0 07 00 00       	push   $0x7b0
  ce:	6a 01                	push   $0x1
  d0:	e8 bb 03 00 00       	call   490 <printf>
  d5:	83 c4 10             	add    $0x10,%esp
  d8:	eb 9e                	jmp    78 <main+0x78>
                a += (int)(3);
            }
            printf(1, "%d\n", a);
  ...
  dd:	52                   	push   %edx
  de:	50                   	push   %eax
  df:	68 c4 07 00 00       	push   $0x7c4
  e4:	6a 01                	push   $0x1
  e6:	e8 a5 03 00 00       	call   490 <printf>
            exit();
  eb:	e8 42 02 00 00       	call   332 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42f:	f7 f6                	div    %esi
 431:	0f b6 92 d4 07 00 00 	movzbl 0x7d4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5ab:	b8 cc 07 00 00       	mov    $0x7cc,%eax
...
free(void *ap)
{
 ...
 631:	a1 74 0a 00 00       	mov    0xa74,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 687:	89 08                	mov    %ecx,(%eax)
  freep = p;
 689:	a3 74 0a 00 00       	mov    %eax,0xa74
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6aa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ad:	a3 74 0a 00 00       	mov    %eax,0xa74
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 74 0a 00 00    	mov    0xa74,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 71f:	76 3f                	jbe    760 <malloc+0xa0>
    ...
    if(p == freep)
 721:	39 05 74 0a 00 00    	cmp    %eax,0xa74
 ...
 746:	e8 e5 fe ff ff       	call   630 <free>
  return freep;
 74b:	8b 15 74 0a 00 00    	mov    0xa74,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 76f:	89 15 74 0a 00 00    	mov    %edx,0xa74
      return (void*)(p + 1);
 ...
 784:	eb e9                	jmp    76f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 74 0a 00 00 78 	movl   $0xa78,0xa74
 78d:	0a 00 00 
 790:	c7 05 78 0a 00 00 78 	movl   $0xa78,0xa78
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 78 0a 00 00       	mov    $0xa78,%eax
 79f:	c7 05 7c 0a 00 00 00 	movl   $0x0,0xa7c
 7a6:	00 00 00 
