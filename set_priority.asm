...
int main(int argc, char *argv[])
{
  ...
  71:	53                   	push   %ebx
  72:	56                   	push   %esi
  73:	e8 fa 02 00 00       	call   372 <set_priority>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 98 07 00 00 	movzbl 0x798(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 8f 07 00 00       	mov    $0x78f,%eax
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 38 0a 00 00       	mov    %eax,0xa38
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 38 0a 00 00       	mov    %eax,0xa38
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 38 0a 00 00    	mov    0xa38,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6af:	76 3f                	jbe    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	39 05 38 0a 00 00    	cmp    %eax,0xa38
 ...
 6d6:	e8 e5 fe ff ff       	call   5c0 <free>
  return freep;
 6db:	8b 15 38 0a 00 00    	mov    0xa38,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ff:	89 15 38 0a 00 00    	mov    %edx,0xa38
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 38 0a 00 00 3c 	movl   $0xa3c,0xa38
 71d:	0a 00 00 
 720:	c7 05 3c 0a 00 00 3c 	movl   $0xa3c,0xa3c
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 3c 0a 00 00       	mov    $0xa3c,%eax
 72f:	c7 05 40 0a 00 00 00 	movl   $0x0,0xa40
 736:	00 00 00 
