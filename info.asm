...
int main(int argc, char *argv[])
{
  ...
  20:	e8 fb 01 00 00       	call   220 <atoi>
    // else
    // {
  ...
  27:	6a 00                	push   $0x0
  29:	50                   	push   %eax
  2a:	e8 03 03 00 00       	call   332 <getpinfo>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38f:	f7 f6                	div    %esi
 391:	0f b6 92 24 07 00 00 	movzbl 0x724(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 508:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 1d 07 00 00       	mov    $0x71d,%eax
