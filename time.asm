...
int main(int argc, char *argv[])
{
  ...
  18:	7e 57                	jle    71 <main+0x71>
	...
	{
		pid = fork();
  1a:	e8 ab 02 00 00       	call   2ca <fork>
		if (pid == 0)
  ...
  29:	e8 dc 02 00 00       	call   30a <exec>
			printf(1, "Exec %s Failed\n", argv[1]);
  2e:	83 c4 0c             	add    $0xc,%esp
  31:	ff 73 04             	pushl  0x4(%ebx)
  34:	68 67 07 00 00       	push   $0x767
  39:	6a 01                	push   $0x1
  3b:	e8 f0 03 00 00       	call   430 <printf>
			exit();
  40:	e8 8d 02 00 00       	call   2d2 <exit>
		}
		else
		{
			status = waitx(&a, &b);
  ...
  4e:	50                   	push   %eax
  4f:	e8 16 03 00 00       	call   36a <waitx>
  ...
  71:	51                   	push   %ecx
  72:	51                   	push   %ecx
  73:	68 50 07 00 00       	push   $0x750
  78:	6a 01                	push   $0x1
  7a:	e8 b1 03 00 00       	call   430 <printf>
		exit();
  7f:	e8 4e 02 00 00       	call   2d2 <exit>
  84:	66 90                	xchg   %ax,%ax
  86:	66 90                	xchg   %ax,%ax
  88:	66 90                	xchg   %ax,%ax
  8a:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 b0 07 00 00 	movzbl 0x7b0(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 a8 07 00 00       	mov    $0x7a8,%eax
...
free(void *ap)
{
 ...
 5d1:	a1 4c 0a 00 00       	mov    0xa4c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 4c 0a 00 00       	mov    %eax,0xa4c
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 4c 0a 00 00    	mov    0xa4c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6bf:	76 3f                	jbe    700 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	39 05 4c 0a 00 00    	cmp    %eax,0xa4c
 ...
 6e6:	e8 e5 fe ff ff       	call   5d0 <free>
  return freep;
 6eb:	8b 15 4c 0a 00 00    	mov    0xa4c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 4c 0a 00 00 50 	movl   $0xa50,0xa4c
 72d:	0a 00 00 
 730:	c7 05 50 0a 00 00 50 	movl   $0xa50,0xa50
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 50 0a 00 00       	mov    $0xa50,%eax
 73f:	c7 05 54 0a 00 00 00 	movl   $0x0,0xa54
 746:	00 00 00 
